                                                      ...
                                                      audio_log( ROW_NBR ), m_sampling_freq( sampl_freq )
{
    ...
    try {
        ...
        m_audio_device.openStream( nullptr,                // RtAudio::StreamParameters for out
                                   ...
                                   &audioBufferStream0,    // RtAudioCallback
...
int audioSource::audioBufferStream0( void *outputBuffer, void *inputBuffer, unsigned int nBufferFrames,
...
void audioSource::logDataInBuff( void *inputBuffer )
{
    ...
    {
        int iter = 0;
        for( ; iter < AUDIO_DEV_BUFFER_FRAMES_NBR; iter++)
        {
